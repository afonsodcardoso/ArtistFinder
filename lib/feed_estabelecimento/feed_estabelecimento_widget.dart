...
import '../perfil_artista_visao_estabelecimento_maria/perfil_artista_visao_estabelecimento_maria_widget.dart';
...
class FeedEstabelecimentoWidget extends StatefulWidget {
  const FeedEstabelecimentoWidget({Key key}) : super(key: key);

  @override
  _FeedEstabelecimentoWidgetState createState() =>
      _FeedEstabelecimentoWidgetState();
}

class _FeedEstabelecimentoWidgetState extends State<FeedEstabelecimentoWidget> {
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      PerfilArtistaVisaoEstabelecimentoMariaWidget(),
                                ),
                              );
                            },
                            text: 'Ver Perfil',
