...
DocumentReference get currentUserReference => currentUser?.user != null
    ? UtilizadorRecord.collection.doc(currentUser.user.uid)
    : null;

UtilizadorRecord currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UtilizadorRecord.getDocument(UtilizadorRecord.collection.doc(uid))
              .handleError((_) {}),
    )
